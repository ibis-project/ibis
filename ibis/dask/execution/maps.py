...
@execute_node.register(ops.MapValueForKey, dd.Series, object)
def execute_map_value_for_key_series_scalar(op, data, key, **kwargs):
    return data.map(functools.partial(safe_get, key=key))


@execute_node.register(ops.MapValueForKey, collections.abc.Mapping, dd.Series)
...
@execute_node.register(ops.MapValueOrDefaultForKey, dd.Series, object, object)
...
@execute_node.register(
    ops.MapValueOrDefaultForKey, dd.Series, object, dd.Series
)
...
@execute_node.register(
    ops.MapValueOrDefaultForKey, dd.Series, dd.Series, object
)
...
@execute_node.register(
    ops.MapValueOrDefaultForKey, dd.Series, dd.Series, dd.Series
)
...
@execute_node.register(
    ops.MapValueOrDefaultForKey, collections.abc.Mapping, dd.Series, dd.Series
)
...
@execute_node.register(ops.MapKeys, dd.Series)
...
@execute_node.register(ops.MapValues, dd.Series)
