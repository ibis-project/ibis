...
from ibis.dask.core import integer_types, scalar_types
from ibis.dask.dispatch import execute_node


@execute_node.register(ops.StringLength, dd.Series)
def execute_string_length_series(op, data, **kwargs):
    return data.str.len().astype('int32')


@execute_node.register(ops.Substring, dd.Series, integer_types, integer_types)
...
@execute_node.register(ops.StringSQLLike, dd.Series, str, (str, type(None)))
...
@execute_node.register(ops.RegexSearch, dd.Series, str)
...
@execute_node.register(
    ops.RegexExtract, dd.Series, (dd.Series, str), integer_types
)
...
@execute_node.register(ops.RegexReplace, dd.Series, str, str)
...
@execute_node.register(ops.Translate, dd.Series, dd.Series, dd.Series)
...
@execute_node.register(ops.Translate, dd.Series, dd.Series, str)
...
@execute_node.register(ops.Translate, dd.Series, str, dd.Series)
...
@execute_node.register(ops.Translate, dd.Series, str, str)
...
@execute_node.register(ops.StrRight, dd.Series, integer_types)
...
@execute_node.register(ops.StringJoin, (dd.Series, str), list)
