...
from ibis.dask.client import DaskClient
from ibis.dask.core import is_computable_input
from ibis.dask.dispatch import execute_node, post_execute, pre_execute
...
def test_execute_parameter_only():
    ...
    result = ibis.dask.execute(param, params={param: 42})
    assert result == 42
