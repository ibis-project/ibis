...
@pytest.mark.parametrize('arr_expr_creator', [ibis.literal, ibis.array])
def test_array_literal(client, arr, arr_expr_creator):
...
@pytest.mark.xfail(
    raises=AttributeError, reason='TODO - Summarize aggcontext - #2553'
)
