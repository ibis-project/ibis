...
@execute_node.register(
    ops.ElementWiseVectorizedUDF, ddgb.SeriesGroupBy, [ddgb.SeriesGroupBy]
)
...
# Define an execution rule for a simple elementwise Series function
@execute_node.register(ops.ElementWiseVectorizedUDF, dd.Series, [dd.Series])
...
@execute_node.register(
    ops.AnalyticVectorizedUDF, ddgb.SeriesGroupBy, [ddgb.SeriesGroupBy]
)
