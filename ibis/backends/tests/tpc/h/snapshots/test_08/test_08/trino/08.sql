WITH "t8" AS (
  SELECT
    *
  FROM "hive"."ibis_tpch_sf1"."nation" AS "t6"
)
SELECT
  *
FROM (
    ...
    FROM (
      ...
      FROM (
        SELECT
          ...
          "t0"."p_comment"
        FROM "hive"."ibis_tpch_sf1"."part" AS "t0"
      ) AS "t16"
      INNER JOIN (
        SELECT
          "t1"."l_orderkey",
          ...
          "t1"."l_shipmode",
          "t1"."l_comment"
        FROM "hive"."ibis_tpch_sf1"."lineitem" AS "t1"
      ) AS "t17"
      ...
      INNER JOIN (
        SELECT
          ...
          "t2"."s_comment"
        FROM "hive"."ibis_tpch_sf1"."supplier" AS "t2"
      ) AS "t18"
      ...
      INNER JOIN (
        SELECT
          ...
          "t3"."o_shippriority",
          "t3"."o_comment"
        FROM "hive"."ibis_tpch_sf1"."orders" AS "t3"
      ) AS "t19"
      ...
      INNER JOIN (
        SELECT
          ...
          "t4"."c_mktsegment",
          "t4"."c_comment"
        FROM "hive"."ibis_tpch_sf1"."customer" AS "t4"
      ) AS "t20"
      ...
      INNER JOIN (
        SELECT
          *
        FROM "hive"."ibis_tpch_sf1"."region" AS "t5"
      ) AS "t14"
