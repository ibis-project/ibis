    ...
    FROM (
      ...
      FROM (
        SELECT
          ...
          "t0"."c_mktsegment",
          "t0"."c_comment"
        FROM "hive"."ibis_tpch_sf1"."customer" AS "t0"
      ) AS "t14"
      INNER JOIN (
        SELECT
          "t1"."o_orderkey",
          ...
          "t1"."o_shippriority",
          "t1"."o_comment"
        FROM "hive"."ibis_tpch_sf1"."orders" AS "t1"
      ) AS "t15"
      ...
      INNER JOIN (
        SELECT
          ...
          "t2"."l_shipmode",
          "t2"."l_comment"
        FROM "hive"."ibis_tpch_sf1"."lineitem" AS "t2"
      ) AS "t16"
      ...
      INNER JOIN (
        SELECT
          ...
          "t3"."s_comment"
        FROM "hive"."ibis_tpch_sf1"."supplier" AS "t3"
      ) AS "t17"
        ON "t16"."l_suppkey" = "t17"."s_suppkey"
      INNER JOIN (
        SELECT
          *
        FROM "hive"."ibis_tpch_sf1"."nation" AS "t4"
      ) AS "t12"
