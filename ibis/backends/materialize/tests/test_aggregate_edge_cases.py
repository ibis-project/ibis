...
# =============================================================================
# DISTINCT ON Edge Cases
# =============================================================================


def test_distinct_on_with_null_order_by_values(con):
...
def test_distinct_on_with_multiple_order_by_columns(con):
...
def test_distinct_on_empty_table(con):
...
def test_distinct_on_all_same_category(con):
...
# =============================================================================
# Aggregates with Empty Groups
# =============================================================================


def test_aggregate_on_empty_table(con):
...
def test_aggregate_with_no_matches_after_filter(con):
...
def test_count_on_empty_group(con):
...
# =============================================================================
# Aggregates with All-NULL Inputs
# =============================================================================


def test_sum_all_nulls(con):
...
def test_min_max_all_nulls(con):
...
# =============================================================================
# Aggregates in Streaming Context
# =============================================================================


def test_aggregate_with_mz_now_filter(con):
...
def test_aggregate_with_mz_now_in_select(con):
    ...
    expr = t.group_by("category").aggregate(total=t.value.sum(), snapshot_time=mz_now())
...
def test_distinct_aggregate_variations(con):
