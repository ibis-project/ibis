...
def connect(
    ...
    partition_column
        ...
        column. Defaults to `'PARTITIONTIME'`.
    generate_job_id_prefix
        Optional callable that generates a bigquery job ID prefix. If specified, for any
        query job, jobs will always be created rather than optionally created by
        BigQuery's `Client.query_and_wait`.
    ...
    return backend.connect(
        ...
        partition_column=partition_column,
        generate_job_id_prefix=generate_job_id_prefix,
    )
