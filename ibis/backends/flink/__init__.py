...
class Backend(BaseBackend, CanCreateDatabase):
    ...
    def create_table(
        ...
        *,
        ...
        primary_key
            Column or comma-separated list of columns to be marked as PRIMARY.
            Raises an error if the columns given in `primary_key` is NOT a subset
            of the columns given in `schema`. Primary keys must be non-nullable
            in Flink and the columns indicated as primary key will be designated
            as non-nullable.
        temp
