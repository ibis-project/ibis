...
_join_classes = {
    ...
    'all_inner': _ops.AllInnerJoin,
    'left': _ops.LeftJoin,
    'any_left': _ops.AnyLeftJoin,
    'all_left': _ops.AllLeftJoin,
...
_table_methods = dict(
    ...
    all_inner_join=_regular_join_method('all_inner_join', 'all_inner'),
    left_join=_regular_join_method('left_join', 'left'),
    any_left_join=_regular_join_method('any_left_join', 'any_left'),
    all_left_join=_regular_join_method('all_left_join', 'all_left'),
