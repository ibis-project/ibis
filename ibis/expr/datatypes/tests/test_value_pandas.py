...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            pd.Timestamp('2015-01-01 12:00:00', tz='UTC'),
            dt.Timestamp('UTC'),
        ),
...
def test_infer_scalar(value, expected_dtype):
...
def test_normalize_numpy_timestamp(value, expected):
