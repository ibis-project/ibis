...
extras_require = {
    ...
    'all:sys_platform != "win32"': ["impyla[kerberos]>=0.17,<0.19"],
    'all:sys_platform == "win32"': ["impyla>=0.17,<0.19"],
    "clickhouse": [
        "clickhouse-driver>=0.1,<0.3",
        "clickhouse-sqlalchemy>=0.1.4,<0.2",
        "sqlalchemy>=1.3,<1.4",
    ...
    'impala:sys_platform != "win32"': ["impyla[kerberos]>=0.17,<0.19"],
    'impala:sys_platform == "win32"': ["impyla>=0.17,<0.19"],
