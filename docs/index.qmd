...
- Run locally on embedded DuckDB, Polars, DataFusion, or SQLite
...
::: {.g-col-4 .card .border-light .mb-3 .text-center}
::: {.card-body}
...
needing to remember the nuances of Druid SQL."]{.card-text}
...
::: {.g-col-4}
[Tutorial: getting started](tutorials/getting_started.qmd){.btn .btn-primary}
:::

::: {.g-col-4}
[Why Ibis?](why.qmd){.btn .btn-primary}
:::

::: {.g-col-4}
[API reference](/reference){.btn .btn-primary}
:::
