...
frontend for any backend data platform, with more than 20 backends today. This
allows Ibis to have excellent performance -- as good as the backend it is
connected to -- with a consistent user experience.
...
- instantly support more than 20 data backends
