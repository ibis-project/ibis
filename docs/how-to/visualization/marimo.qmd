...
[marimo](https://docs.marimo.io) is a reactive notebook for Python that provides interactive UI elements and dataframe tools. You can use marimo's interactive features directly with your Ibis tables.
