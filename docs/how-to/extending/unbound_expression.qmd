...
Polars as an example, but you can do the same for any of Ibis' more than 20
supported backends as long as that particular backend supports the operations
