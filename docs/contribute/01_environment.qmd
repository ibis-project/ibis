...
for manager, params in managers.items():
    ...
    print()
    print(f"{next(step)}. Install `gh` and `conda-lock`")
    print()
    print("    ```sh")
    print(f"    {manager} install -c conda-forge gh conda-lock")
    print("    ```")
    print()
    ...
    print("    ```")
    print()
    print(f"{next(step)}. Create a Conda environment from a lock file:")
    print()
    print("```sh")
    print(f"# Create a dev environment")
    print("cd ibis")
    print(f"{manager} create --name ibis-dev python=3.10")
    print(f"conda-lock install --name ibis-dev --file ci/conda-lock/python-3.10.yml")
    print("```")
    print()
