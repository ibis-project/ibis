...
::: {.callout-tip}
If you're getting reference errors (e.g., `reference/operations.qmd` not found), you may need to run
```bash
just docs-api-preview
```
which first generates the API docs and then spins up the preview.
