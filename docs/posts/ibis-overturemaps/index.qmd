...
be interesting to see in a plot the entire power lines infrastructure of most of the USA (excluding territories and Alaska for simplicity of the bounding box).
...
Looks like we have `power_lines` and `minor_lines`, so we can plot them both.
...
# lonboard warns you about no CRS exists on data, I'm filtering this warning because in this case we are on CRS WGS84
import warnings
