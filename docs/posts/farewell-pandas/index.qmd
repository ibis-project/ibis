...
TLDR; we are deprecating the `pandas` backend and will be removing it in version 10.0
...
This is the real reason to drop the `pandas` backend -- it is redundant.  The
