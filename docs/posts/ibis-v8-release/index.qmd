...
[RisingWave](https://risingwave.com) backends in this release. We've also added
a new batch backend with [Exasol](https://exasol.com), bringing the total number
of backends Ibis supports to 20.
...
low latency and is increasingly common in modern data
applications.
