...
:::{.callout-tip}
We'll only look at a subset of the data in this blog. All the data is public, so
you can follow along with the code and visualize the data yourself.

You can also see the [Ibis benchmarking Streamlit
