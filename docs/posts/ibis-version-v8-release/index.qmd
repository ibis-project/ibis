---
title: "Ibis v8: streaming and more!"
author: "Ibis team"
date: "2024-02-05"
categories:
    - release
...
excited to begin bridging the gap between batch and streaming systems, starting
with [Apache Flink](https://flink.apache.org/) and
[RisingWave](https://risingwave.com) backends in this release.
...
Data streaming is a method of processing data continuously as it arrives rather
than in batches at points in time. This is useful for applications that require
low latency and increasingly common in modern data applications.
...
Regardless of whether you're using a batch or streaming data platform -- and the
lines are continunally blurring between them -- you'll need a frontend to
interact with as a data engineer, analyst, or scientist. If you're using Python,
that frontend is likely a dataframe API.
...
Ibis aims to solve this dillemma by providing a standard dataframe API that can
work across data systems, whether batch or streaming. This is a long-term vision
and we're exicted to take the first steps toward it in Ibis v8 with the launch
...
The largest breaking change in Ibis v7/v8 is the deprecation of `relabel` in
...
A lot of new functionality has been added in Ibis v7/v8.
...
Ibis v8 brings exciting new features and the first streaming backends into Ibis!
We hope you're exicted as we are about breaking down barriers between batch and
