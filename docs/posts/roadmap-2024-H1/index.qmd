...
going. Feel free to [skip ahead to the roadmap](#2024-roadmap) if you're already
familiar with Ibis.

## Background

The Ibis project was started in 2015 by [Wes McKinney](https://wesmckinney.com),
the creator of pandas, as a pandas-like interface to Apache Impala. It receieved
...
backends (including Apache Impala!) and is improving rapidly. It's never been a
...
for the composable data ecosystem. On its own, Theseus is fairly useless -- it
...
with deep experience on succcessful open-source projects including pandas,
...
coverting the majority of feature engineering operations and handoff to popular
...
revamped most of the webiste along the way. We will continue improving the
