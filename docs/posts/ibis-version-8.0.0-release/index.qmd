...
[second streaming backend with RisingWave](../../backends/risingwave.qmd). This
backend is earlier in development, but we're excited to have it as the second
streaming backend in Ibis and will continue to improve it.
