...
Python](https://realpython.com/podcasts/rpp/201) where Phillip Cloud, lead
maintainer of Ibis, talks about the project.
...
contributions. We're excited to ahve her on board!
...
For geospatial operations, casting from binary to geometry is now supported.
...
bit operations, time operations, and hexdigest.
