...
the composable data ecosystem, co-foudning Voltron Data, Apache Arrow, and
...
consitute a standard. Going forward, we expect ADBC and Substrait to be the
standards for connectivity and intermediate represetation, respectively.
...
designed to be a more modern, lightweight, and performant alternative to these
standards.
...
in practice it is not possible to simply re-use SQL from one execution engine on
