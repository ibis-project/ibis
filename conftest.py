...
def get_spark_testing_client():
    ...
    try:
        ...
        df_functional_alltypes = s.read.csv(
            path=str(get_data_directory() / 'functional_alltypes.csv'),
        ...
        df_batting = s.read.csv(
            path=str(get_data_directory() / 'batting.csv'),
            schema=pt.StructType([
        ...
        df_awards_players = s.read.csv(
            path=str(get_data_directory() / 'awards_players.csv'),
            schema=pt.StructType([
                pt.StructField('playerID', pt.StringType(), True),
